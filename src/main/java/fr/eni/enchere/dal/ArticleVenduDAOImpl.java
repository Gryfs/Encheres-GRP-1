...
public class ArticleVenduDAOImpl implements ArticleVenduDAO {
	...
	private final static String SELECT_ALL = "SELECT no_article, nom_article, description, date_debut_encheres, date_fin_encheres, prix_initial, prix_vente, no_categorie, no_utilisateur, image FROM articles_vendus";
    ...
    private final static String SELECT_ALL_BY_CATEGORIE = "SELECT no_article, nom_article, description, date_debut_encheres, date_fin_encheres, prix_initial, prix_vente, no_categorie, no_utilisateur, image FROM articles_vendus WHERE no_categorie = :no_categorie";
    private final static String SELECT_BY_NOM = "SELECT no_article, nom_article, description, date_debut_encheres, date_fin_encheres, prix_initial, prix_vente, no_categorie, no_utilisateur, image FROM articles_vendus WHERE LOWER(nom_article) LIKE LOWER(:search)";
