...
public class ArticleVenduDAOImpl implements ArticleVenduDAO {
	...
	public List<ArticleVendu> findExpiredAuctions(LocalDate today) {
	    ...
	    // Exécuter la requête et mapper les résultats avec ArticleRowMapper
	    return namedParameterJdbcTemplate.query(SELECT_EXPIRED_AUCTIONS, params, new ArticleRowMapper());
	}
