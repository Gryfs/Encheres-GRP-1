...
public class UtilisateurDAOImpl implements UtilisateurDAO {
	...
	public List<Utilisateur> findAll() {
		...
		return namedParameterJdbcTemplate.query(SELECT_ALL, new BeanPropertyRowMapper<>(Utilisateur.class));
	}
	...
	public Utilisateur findByResetToken(String token) {
		try {
			...
			return namedParameterJdbcTemplate.queryForObject(FIND_BY_RESET_TOKEN, namedParameters,
					new BeanPropertyRowMapper<>(Utilisateur.class));
		} catch (EmptyResultDataAccessException e) {
			return null;
		}
